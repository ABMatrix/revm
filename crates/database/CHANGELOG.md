...
## [1.0.0](https://github.com/bluealloy/revm/releases/tag/revm-database-v1.0.0) - 2024-09-26

### Added

- add support for async database ([#1809](https://github.com/bluealloy/revm/pull/1809))
- restructure part3 fix examples  ([#1792](https://github.com/bluealloy/revm/pull/1792))
